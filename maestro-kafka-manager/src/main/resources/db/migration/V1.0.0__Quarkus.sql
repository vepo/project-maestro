...
create table tbl_cluster_ssl_credentials (
  id                  BIGINT GENERATED BY DEFAULT AS IDENTITY,
  truststore          OID,
  truststore_filename VARCHAR(255), 
...
INSERT INTO tbl_clusters (name, bootstrap_servers, protocol, access_ssl_credentials_id, created_at, updated_at) VALUES ('Main Cluster', 'kafka-0:9092, kafka-1:9094, kafka-2:9096', 'PLAINTEXT', null, NOW(), NOW());
